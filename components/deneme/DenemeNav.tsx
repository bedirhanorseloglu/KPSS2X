...
const links = [
  { href: "/dashboard", label: "Gösterge Paneli", emoji: "🌟" },
  { href: "/deneme", label: "Deneme Merkezi", emoji: "📊" },
  { href: "/simulator", label: "Simülatör", emoji: "⏱️" },
  { href: "/liderlik", label: "Liderlik Tablosu", emoji: "🏆" },
  { href: "/etkinlik", label: "Etkinlikler", emoji: "🎮" },
];
