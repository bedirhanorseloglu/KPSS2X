      ...
      <div className={`mx-auto w-full transition-all duration-500 ${stage === "map" ? "max-w-[1600px]" : "max-w-4xl"}`}>
        ...
        <AnimatePresence mode="wait">
          {stage === "menu" && (
            ...
            >
              ...
              <motion.div
                ...
                className="w-24 h-24 rounded-[2rem] bg-[#1cb0f6]/15 border-2 border-b-[6px] border-[#1cb0f6]/40 border-b-[#1cb0f6] flex items-center justify-center mb-6 shadow-xl relative"
              >
                <AppleEmoji emoji="🌊" size={48} color="#1cb0f6" />
              </motion.div>
              ...
              <p className="text-base sm:text-lg text-slate-500 dark:text-slate-400 font-bold mb-10 max-w-xl">
                Türkiye'nin akarsularını keşfet. Önce özelliklerini öğren, ardından interaktif haritada yerlerini tespit et!
              </p>
              ...
              <div className="grid sm:grid-cols-2 gap-6 w-full">
                ...
                >
                  <div>
                    ...
                    <p className="text-slate-500 dark:text-slate-400 font-bold text-xs sm:text-sm leading-relaxed mb-6">
                      Boşluk doldurma ve eşleştirmeler ile akarsu özelliklerini, kollarını ve döküldüğü denizleri zihnine kazı.
                    </p>
                  </div>
                ...
                <motion.div
                  ...
                  className="bg-white dark:bg-slate-800 p-6 sm:p-7 rounded-[2rem] border-2 border-b-[6px] border-slate-200 dark:border-slate-700 shadow-lg text-left flex flex-col justify-between group cursor-pointer relative overflow-hidden transition-colors hover:border-[#1cb0f6] dark:hover:border-[#1cb0f6]"
                >
                  <div>
                    <div className="flex items-center justify-between mb-5">
                      <div className="w-16 h-16 rounded-2xl bg-[#1cb0f6]/15 border-2 border-b-4 border-[#1cb0f6]/40 border-b-[#1cb0f6] flex items-center justify-center shadow-sm group-hover:scale-105 transition-transform">
                        <AppleEmoji emoji="🗺️" size={32} color="#1cb0f6" />
                      </div>
                      <span className="text-[10px] font-black uppercase tracking-wider px-3 py-1 rounded-xl bg-[#1cb0f6]/15 text-[#1cb0f6] border-2 border-b-2 border-[#1cb0f6]/30">
                        2. AŞAMA
                      </span>
                    </div>

                    <h3 className="text-2xl font-black text-slate-800 dark:text-white mb-2 tracking-tight group-hover:text-[#1cb0f6] transition-colors">
                      Harita Simülatörü
                    </h3>
                    <p className="text-slate-500 dark:text-slate-400 font-bold text-xs sm:text-sm leading-relaxed mb-6">
                      Seterra tarzı interaktif Türkiye haritasında akarsuların rotasını ve yerlerini bularak pratiğini yap.
                    </p>
                  </div>

                  <button
                    type="button"
                    className="w-full py-3.5 rounded-xl bg-[#1cb0f6] text-white font-black text-xs uppercase tracking-wider flex items-center justify-center gap-2 border-2 border-b-4 border-[#1cb0f6] border-b-[#1899d6] shadow-sm active:translate-y-0.5 transition-all"
                  >
          ...
          {stage === "story" && (
            ...
            >
              <div className="flex items-center justify-between mb-8">
                <h2 className="text-2xl font-black text-slate-800 dark:text-white tracking-tight">Nehrin Serüveni</h2>
                <button 
          ...
          {stage === "map" && (
            ...
            >
              <div className="flex items-center justify-between mb-8">
                <h2 className="text-2xl font-black text-slate-800 dark:text-white tracking-tight">Haritada Nehir Avcısı</h2>
                <button 
                  onClick={() => setStage("menu")} 
                  className="inline-flex items-center gap-1.5 px-3.5 py-1.5 bg-white dark:bg-slate-800 rounded-xl border-2 border-b-4 border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 font-black text-xs uppercase tracking-wider hover:border-[#1cb0f6] hover:text-[#1cb0f6] dark:hover:border-[#1cb0f6] dark:hover:text-[#38bdf8] active:translate-y-0.5 transition-all shadow-sm cursor-pointer"
                >
